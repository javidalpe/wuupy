...
@section('content')
<h2>{{ config('app.name') }} Terms of Service and Privacy Policy</h2>
...
<h3>2. Use License</h3>
  ...
  <p>Payment processing services for premium accounts on {{ config('app.name') }} are provided by Stripe and are
      subject to the <a href="https://stripe.com/connect-account/legal">
          ...
          these terms on {{ config('app.name') }}, you agree to be bound
...
<h2>Privacy Policy</h2>
  ...
  <p>It is {{ config('app.name') }}'s policy to respect your privacy regarding any information we may collect while operating our website. Accordingly, we have developed this privacy policy in order for you to understand how we collect, use, communicate, disclose and otherwise make use of personal information. We have outlined our privacy policy below.</p>
  ...
  <p>We are committed to conducting our business in accordance with these principles in order to ensure that the confidenti
@endsection
